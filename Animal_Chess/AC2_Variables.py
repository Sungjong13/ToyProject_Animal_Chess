...
def move_entity(entityname,entityowner,move_from,move_to):
...
def kill_entity(entityname,entityowner,location):
    tile_dic[location][0]='Empty'
    tile_dic[location][1]='No_Owner'
    if entityowner=='P2':
        if tile_dic['E1'][0]=='Empty':
            tile_dic['E1'][0]=entityname
            tile_dic['E1'][1]='P1'
        elif tile_dic['E2'][0]=='Empty':
            tile_dic['E2'][0]=entityname
            tile_dic['E2'][1]='P1'
        elif tile_dic['E3'][0]=='Empty':
            tile_dic['E3'][0]=entityname
            tile_dic['E3'][1]='P1'
        else:
            tile_dic['E4'][0]=entityname
            tile_dic['E4'][1]='P1'
    elif entityowner=='P1':
        if tile_dic['F1'][0]=='Empty':
            tile_dic['F1'][0]=entityname
            tile_dic['F1'][1]='P2'
        elif tile_dic['F2'][0]=='Empty':
            tile_dic['F2'][0]=entityname
            tile_dic['F2'][1]='P2'
        elif tile_dic['F3'][0]=='Empty':
            tile_dic['F3'][0]=entityname
            tile_dic['F3'][1]='P2'
        else:
            tile_dic['F4'][0]=entityname
            tile_dic['F4'][1]='P2'
